...
class RsValidator extends ConstraintValidator
{
    /**
     * @param mixed $value
     * @param Rs|Constraint $constraint
     */
    public function validate($value, Constraint $constraint)
    {
        ...
        if (preg_match('/[^0-9]/', $value)) {
            $this->context
                ...
                ->setCode(Rs::INVALID_CHARACTERS_ERROR)
                ->addViolation()
            ;
        ...
        if (strlen($value) !== 20) {
            $this->context
                ...
                ->setCode(Rs::INVALID_LENGTH_ERROR)
                ->addViolation()
            ;
        ...
        if ($checksum % 10 !== 0) {
            $this->context
                ...
                ->setCode(Rs::INVALID_CHECKSUM_ERROR)
                ->addViolation()
            ;
        }
    }
